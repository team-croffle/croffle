---
description: Plan the next roadmap version — write .ai/plan/<version>_<feature>.md and its work files.
---

Plan the **next version** (definition in the workflow below). Optional hint from the user: $ARGUMENTS
